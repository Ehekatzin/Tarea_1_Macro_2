...
siguiendo estos pasos:[2 horas, 1 punto cada inciso]
...
Cree 20 vectores de 100 ingresos transitorios aleatorios $Y^P_{i,t}$, distribuidos normalmente, con media 0 y con varianza $\sigma^T>0$ (escoja esta varianza a su gusto). Grafíque algunos de estos.
...
Cree 20 vectores de 100 ingresos totales $Y_{i,t}$, sumando el ingreso transitorio y el permanente. Grafíque algunos de estos.
