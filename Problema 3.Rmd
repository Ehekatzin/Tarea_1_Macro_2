...
series_3 <- read_excel("C:/Users/germa/OneDrive/Escritorio/Segundo Semestre/Macro 2/Tarea 1/Base_consumo_encadenada.xlsx")
...
\begin{equation}
X_t^{2013} = (1+ \frac{X_{t}^{1993}}{X_{t+1}^{1993}})X_{t+1}^{2013} 
\end{equation}
